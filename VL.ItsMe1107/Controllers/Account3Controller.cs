...
{
    [Authorize]
    public class Account3Controller : BaseController
    {
        ...
        #region 辅助方法
        private void AddMessages(Report result)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction(nameof(HomeController.Index), HomeController.PageNameOfHome);
                }
                AddMessages(result);
            }
            return View(model);
        ...
        {
            return code == null ? View(PageNameOfError) : View();
        }
