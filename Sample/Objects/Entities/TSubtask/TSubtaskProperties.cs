...
{
    public class TSubtaskProperties
    {
        #region Properties
        ...
        public static PDMDbProperty Where { get; set; } = new PDMDbProperty(nameof(Where), "Where", "哪里做(地点)", false, PDMDataType.nvarchar, 1000, 0, true, null);
        public static PDMDbProperty Who { get; set; } = new PDMDbProperty(nameof(Who), "Who", "参与者(人)", false, PDMDataType.nvarchar, 1000, 0, true, null);
