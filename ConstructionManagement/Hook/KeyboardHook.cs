// /////////////////////////////////////////////////////////////
// File: KeyboardHook.cs	Class: PmSoft.Common.CommonClass.Hook.KeyboardHook
...
namespace PmSoft.ConstructionManagement.Hook
{
	...
	public class KeyboardHook : SystemHook
	{
		...
		public delegate bool KeyboardEventHandler(KeyboardEvents kEvent, System.Windows.Forms.Keys key);
		...
		protected override bool HookCallback(int code, UIntPtr wparam, IntPtr lparam)
		{
			...
			return KeyboardEvent(kEvent, key);
		}
