...
namespace PMSoft.ConstructionManagementV2.DomainModel
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TEarthworkBlock entity, DbSession session)
        {
            ...
            query.DeleteBuilder.ComponentWhere.Add(new ComponentValueOfWhere(TEarthworkBlockProperties.Segregation, entity.Segregation, LocateType.Equal));
        ...
        public static bool DbDelete(this List<TEarthworkBlock> entities, DbSession session)
        {
            ...
            query.DeleteBuilder.ComponentWhere.Add(new ComponentValueOfWhere(TEarthworkBlockProperties.Segregation, Ids, LocateType.In));
            return session.GetQueryOperator().Delete<TEarthworkBlock>(query);
        }
        ...
        public static bool DbUpdate(this TEarthworkBlock entity, DbSession session, params PDMDbProperty[] fields)
        {
            ...
            builder.ComponentWhere.Add(new ComponentValueOfWhere(TEarthworkBlockProperties.Segregation, entity.Segregation, LocateType.Equal));
        ...
        public static TEarthworkBlock DbSelect(this TEarthworkBlock entity, DbSession session, params PDMDbProperty[] fields)
        {
            ...
            if (fields.Count() == 0)
            {
                builder.ComponentSelect.Add(TEarthworkBlockProperties.Segregation);
        ...
        public static List<TEarthworkBlock> DbSelect(this List<TEarthworkBlock> entities, DbSession session, params PDMDbProperty[] fields)
        {
            ...
            if (Ids.Count() != 0)
            {
                builder.ComponentWhere.Add(new ComponentValueOfWhere(TEarthworkBlockProperties.Segregation, Ids, LocateType.In));
            }
            query.SelectBuilders.Add(builder);
