...
namespace PmSoft.ConstructionManagement.SubsidenceMonitor.UI
{
    public partial class ChartForm : Form
    {
        ...
        List<TypeKeyDdscription> TypeKeyDescriptions = new List<TypeKeyDdscription>()
        {
            ...
            new TypeKeyDdscription(EIssueType.地表沉降,nameof(SurfaceSubsidenceDataV1.SumChanges),"累计变量(mm)"),
        ...
        private void btn_Export_Click(object sender, EventArgs e)
        {
            ...
            var series = xlBook.ActiveChart.SeriesCollection(1) as Series;
            series.Name = nodeCode;
            ...
            int minEndX = 10;
            range = xlSheet.get_Range(xlSheet.Cells[dataStartX - 1, 3], xlSheet.Cells[Math.Max(minEndX, dataEndX), totalWidth]);
