...
namespace PmSoft.ConstructionManagement.SubsidenceMonitor.Entities
{
        ...
        where T : BuildingSubsidenceDataV1, new()
    {
        ...
        private IEnumerable<T> getWarnResult(WarnSettings warnSettings, TDetail detail, double warnCoefficientMin, out AnalizeResultCollection analysis)
        {
            ...
            //需预警的节点
            //监测
            var sumMillimeter = warnSettings.BuildingSubsidence_SumMillimeter;
            ...
            if (totalHourRange != 0)
            {
                var dailyMillimeter = warnSettings.BuildingSubsidence_DailyMillimeter;
        ...
        //private IEnumerable<T> getWarnResult(WarnSettings warnSettings, TDetail detail, double warnCoefficientMin, double overCoefficientMax)
        //{
        //    List<T> result = new List<T>();
        //    var d = Datas.FirstOrDefault();
        //    if (d == null)
