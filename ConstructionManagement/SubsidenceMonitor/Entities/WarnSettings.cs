...
namespace PmSoft.ConstructionManagement.SubsidenceMonitor.Entities
{
    public class WarnSettings
    {
        ...
        //钢支撑轴力
        public int STBAP_MaxAxleRate { set; get; } = int.MinValue;
        public int STBAP_MinAxleRate { set; get; } = int.MinValue;
        public int STBAP_StandardAxle { set; get; } = int.MinValue;
        //管线沉降(有压)
        ...
        public int PressedPipeLineSubsidence_WellNow { set; get; } = int.MinValue;
        //管线沉降(无压)
        ...
        public int UnpressedPipeLineSubsidence_WellNow { set; get; } = int.MinValue;
        //墙体水平位移(侧斜)
        ...
        public int SkewBack_WellNow { set; get; } = int.MinValue;
        public int SkewBack_StandardNow { set; get; } = int.MinValue;
        ...
        //钢支撑轴力
        public static string Tag_STBAP_AxlePower{set;get;}= "钢支撑轴力_设计轴力";
